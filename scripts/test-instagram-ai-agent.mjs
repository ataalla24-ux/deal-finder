...
assert.match(freshnessRejectionReason(staleWithoutEnd), /72 Stunden/i);
assert.equal(buildHeuristicDeal(staleWithoutEnd), null);
...
assert.match(futureRange.rejectionReason, /noch nicht gestartet/i);
