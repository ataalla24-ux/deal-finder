...
const rawEdit = {
  ...
  location: payloadValue(payload, 'location', 'LIVE_DEAL_EDIT_LOCATION'),
  address: payloadValue(payload, 'address', 'LIVE_DEAL_EDIT_ADDRESS'),
  logo: payloadValue(payload, 'logo', 'LIVE_DEAL_EDIT_LOGO'),
  logoUrl: payloadValue(payload, 'logoUrl', 'LIVE_DEAL_EDIT_LOGO_URL'),
