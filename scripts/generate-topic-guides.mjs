...
const guides = [
  ...
  },
  {
    ...
    title: 'Geburtstag gratis in Wien: Essen oder Eintritt kostenlos',
    meta: 'Geburtstag kostenlos in Wien: gratis essen bei Watertuin oder freier Eintritt zum Donauturm – mit Zeitfenster, Reservierung, Ausweis und Begleitkosten.',
    eyebrow: 'Geburtstag gratis Wien',
    headline: 'Geburtstag gratis in Wien: Essen oder Eintritt kostenlos nutzen.',
    intro: 'Geburtstag gratis essen in Wien oder als Geburtstagskind kostenlos Eintritt bekommen: Dieser Vergleich zeigt zwei laufende, am 14. September 2026 direkt beim Anbieter geprüfte Vorteile – inklusive Zeitfenster, Nachweis und Begleitkosten.',
    modified: '2026-09-14', modifiedLabel: '14. September 2026',
