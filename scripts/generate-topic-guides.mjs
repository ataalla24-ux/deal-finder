...
const guides = [
  ...
  },
  {
    ...
    title: 'Geburtstag gratis in Wien 2026: Essen, Eintritt & Öffis',
    meta: 'Geburtstag gratis in Wien 2026: gratis Essen, kostenloser Eintritt und Öffis prüfen – mit Voraussetzungen, Ausweis und Begleitkosten.',
    eyebrow: 'Geburtstag gratis Wien',
    headline: 'Geburtstag gratis in Wien 2026: Essen, Eintritt und Öffis prüfen.',
    intro: 'Geburtstag gratis essen in Wien oder als Geburtstagskind kostenlos Eintritt bekommen? Dieser Vergleich zeigt zwei laufende, am 23. September 2026 direkt beim Anbieter geprüfte Vorteile – plus die altersabhängige Öffi-Regel für Kinder und Schüler*innen.',
    modified: '2026-09-23', modifiedLabel: '23. September 2026',
    ...
    sections: [
      ...
      ['vor-ort', 'Geburtstagskind gratis: Zwei Wege ohne Kassa-Überraschung', `<p>Wähle vor der Anfahrt nur den Weg, der zu deinem Datum und eurer Gruppe passt. So verwechselst du keinen kostenlosen Vorteil mit einem Gutschein oder einer allgemeinen Restaurantreservierung.</p><ol><li><strong>Für Watertuin:</strong> Reserviere den Besuch vorab für den Geburtstag. Plane mindestens eine erwachsene, vollzahlende Begleitperson ein und nenne den Geburtstagsvorteil vor der Bestellung. Liegt der Geburtstag auf einem Dienstag, prüfe die auf der Aktionsseite genannte Ausnahme für Mittwoch oder Donnerstag noch einmal.</li><li><strong>Für den Donauturm:</strong> Lege den Termin höchstens zwei Tage vor oder nach dem Geburtstag und nimm einen gültigen Lichtbildausweis mit. Melde dich direkt am Front Desk; eine Tischreservierung im Restaurant ersetzt laut Donauturm keinen Eintritt. Rechne Eintritt und Rutsche für Begleitpersonen separat.</li></ol><p>Bei beiden Wegen gilt: Die Originalseite ist die maßgebliche Zusage. Die hier genannten Aktionen sind laufend und können ohne kalendarisches Ablaufdatum geändert oder widerrufen werden.</p>`],
      ...
      ['plan', 'Geburtstag gratis essen und Eintritt: der 60-Sekunden-Plan', `<ol><li><strong>Datum abgleichen:</strong> Für Watertuin muss es der Geburtstag sein; beim Donauturm liegt das mögliche Fenster zwei Tage davor bis zwei Tage danach.</li><li><strong>Voraussetzung auswählen:</strong> Watertuin vorher reservieren und eine vollzahlende erwachsene Person einplanen; zum Donauturm einen gültigen Lichtbildausweis mitnehmen.</li><li><strong>Vor Abfahrt die Originalseiten öffnen:</strong> Beide Vorteile sind laufend, aber ohne festes Enddatum und können sich ändern.</li><li><strong>Begleitkosten realistisch rechnen:</strong> Beim Watertuin zahlt die Begleitperson den Vollpreis; beim Donauturm zahlen Begleitpersonen Eintritt und gegebenenfalls die Rutsche regulär.</li></ol><p>Für weitere kurzfristige Treffer nutze <a href="/angebote-wien-heute.html">Angebote in Wien heute</a>; dort stehen ausgewählte Deals mit erfasstem Enddatum. Laufende Geburtstagsaktionen ohne festes Ende solltest du immer direkt beim Anbieter kontrollieren.</p>`],
    ],
    faqs: [
      ...
      ['Kann ich die Geburtstagsvorteile auch vor oder nach dem Geburtstag einlösen?', 'Beim Donauturm gilt das Angebot bis zu zwei Tage vor oder nach dem Geburtstag. Watertuin nennt grundsätzlich den Geburtstag selbst; für einen Geburtstag an einem Dienstag nennt die offizielle Seite Mittwoch oder Donnerstag als Ausnahme.'],
