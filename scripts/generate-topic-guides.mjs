...
const guides = [
  ...
  },
  {
    ...
    title: 'Geburtstag gratis in Wien: Essen, Eintritt & Öffis',
    meta: 'Geburtstag kostenlos in Wien: gratis Essen, Eintritt oder altersabhängige Öffis richtig prüfen – mit Zeitfenster, Ausweis und Begleitkosten.',
    eyebrow: 'Geburtstag gratis Wien',
    headline: 'Geburtstag gratis in Wien: Essen, Eintritt und Öffis richtig prüfen.',
    intro: 'Geburtstag gratis essen in Wien oder als Geburtstagskind kostenlos Eintritt bekommen: Dieser Vergleich zeigt zwei laufende, am 21. September 2026 direkt beim Anbieter geprüfte Vorteile – plus die altersabhängige Öffi-Regel für Kinder und Schüler*innen.',
    modified: '2026-09-21', modifiedLabel: '21. September 2026',
