...
const guides = [
  ...
  },
  {
    ...
    intro: 'Geburtstag gratis essen in Wien oder als Geburtstagskind kostenlos Eintritt bekommen: Hier stehen zwei laufende, am 6. September 2026 direkt beim Anbieter geprüfte Vorteile mit den entscheidenden Bedingungen.',
    modified: '2026-09-06', modifiedLabel: '6. September 2026',
    ...
    sections: [
      ...
      ['plan', 'Geburtstag gratis essen und Eintritt: der 60-Sekunden-Plan', `<ol><li><strong>Watertuin zuerst reservieren:</strong> Der Geburtstag muss auf den Besuchstag fallen; zusätzlich braucht es mindestens eine vollzahlende erwachsene Person.</li><li><strong>Donauturm passend legen:</strong> Der Vorteil gilt bis zwei Tage vor oder nach dem Geburtstag. Nimm einen gültigen Lichtbildausweis mit.</li><li><strong>Vor Abfahrt die Originalseiten öffnen:</strong> Beide Vorteile sind laufend, aber ohne festes Enddatum und können sich ändern.</li><li><strong>Begleitkosten realistisch rechnen:</strong> Beim Watertuin zahlt die Begleitperson den Vollpreis; beim Donauturm zahlen Begleitpersonen Eintritt und gegebenenfalls die Rutsche regulär.</li></ol><p>Für weitere kurzfristige Treffer nutze <a href="/angebote-wien-heute.html">Angebote in Wien heute</a>; dort stehen ausgewählte Deals mit erfasstem Enddatum. Laufende Geburtstagsaktionen ohne festes Ende solltest du immer direkt beim Anbieter kontrollieren.</p>`],
    ],
    faqs: [
