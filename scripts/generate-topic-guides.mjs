...
const guides = [
  ...
  },
  {
    ...
    title: 'Geburtstag gratis in Wien: gratis Essen & Eintritt',
    meta: 'Geburtstag gratis in Wien: gratis essen bei Watertuin oder als Geburtstagskind kostenlos zum Donauturm – mit Reservierung, Ausweis und Bedingungen.',
    eyebrow: 'Geburtstag gratis Wien',
    headline: 'Geburtstag gratis in Wien: gratis essen und Eintritt sichern.',
    intro: 'Geburtstag gratis essen in Wien oder als Geburtstagskind kostenlos Eintritt bekommen: Hier stehen zwei laufende, am 7. September 2026 direkt beim Anbieter geprüfte Vorteile mit den entscheidenden Bedingungen.',
    modified: '2026-09-07', modifiedLabel: '7. September 2026',
